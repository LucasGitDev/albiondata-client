...
func (op operationAuctionGetOffers) Process(state *albionState) {
	log.Println("Got AuctionGetOffers operation...")
...
func (op operationAuctionGetOffersResponse) Process(state *albionState) {
	log.Println("Got response to AuctionGetOffers operation...")
	...
	log.Printf("Sending %d live market sell orders to ingest (Identifier: %s)", len(orders), identifier)
